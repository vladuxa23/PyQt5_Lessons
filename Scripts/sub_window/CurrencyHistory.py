...
class CurrencyHistory(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.setWindowIcon(QtGui.QIcon(":/ico/ico/Get Info.ico"))

        labelCurrencyImg = QtWidgets.QLabel()
        currencyLogo = QtGui.QPixmap(":/img/img/currency.jpg")
        labelCurrencyImg.setPixmap(currencyLogo.scaled(250, 250, QtCore.Qt.KeepAspectRatio, QtCore.Qt.FastTransformation))
        ...
        layoutV.addWidget(labelCurrencyImg)
